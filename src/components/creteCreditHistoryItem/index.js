...
const CreatingCreditHistoryItem = (props) => {
   const {Data,deleteDebitUser} = props
   // console.log(Data)
   const {amount,debitorName,debitorNumber,date} = Data
   const Delete = () => {
      deleteDebitUser(Data)
   }
   return(
      <li className="bg-success-subtle border border-success-subtle rounded-3 mb-2 list-item">
...
export default CreatingCreditHistoryItem